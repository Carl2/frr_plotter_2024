...
from col.common.split_by import split_by, create_data
from col.plot.plot import make_stage_plot_by_name, make_stage_plot_by_name2
from col.common.utils import convert_to_time_repr
...
# TODO: This should be replaced by col.common.util.convert_to_val
...
def main():
    ...
    make_stage_plot_by_name2(df,'Stage', 'Name', "plot_rider_times.svg", handle_rider)
    make_stage_plot_by_name2(df, 'Stage' ,'Name', "plot_rider_egap.svg", handle_egap)
    make_stage_plot_by_name2(df, 'Stage', 'Name', "plot_rider_pos.svg", handle_pos)
